...
func (l *DistributedLog) setupRaft(dataDir string) error {
	...
	retain := 1 // Number of snapshots to keep
	...
	config.LocalID = l.config.Raft.LocalID // Unique ID for the server
...
const RaftRPC = 1 // Value used for multiplexing Raft on the same port as our Log gRPC requests
